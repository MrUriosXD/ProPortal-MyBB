...
if (!defined("IN_BLOG")) {
	die("<div style=\"border:1px solid #CC0000; padding:3px; margin:0; font-family:Tahoma; width:250px; font-size:12px;\"><strong>Warning:</strong> You do not have permission to view this file.</div>");
}
