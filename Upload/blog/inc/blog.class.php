...
class ProBlog {
	...
	public $pversion = "1.0";
	public $pversion_code = 100;
	public $pupdate = "16/09/2025";
	public $required_version = "1.8.0";
	...
	function page_title($content, $title)
	{
		...
		$blog = preg_replace("/<title>(.*)<\/title>/", "<title>{$title} - {$mybb->settings['bbname']}</title>", $content);
		return $blog;
	}
}
?>