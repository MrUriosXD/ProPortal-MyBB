...
$l['is_not_installed'] = "ProBlog haven't been installed yet. Please run ProBlog installation wizard and install blog.";
$l['nav_blog'] = "Blog";
...
$l['messagemore'] = "[ Read more ]";
$l['posted_by'] = "Posted by:";
$l['replies'] = "Replies";
$l['no_replies'] = "No Replies";
$l['latest_threads'] = "Latest Posts";
$l['latest_threads_thread'] = "Post Title";
$l['latest_threads_replies'] = "Replies";
$l['latest_threads_views'] = "Views";
$l['latest_threads_lastpost'] = "Last Comment";
...
$l['forum_stats'] = "Blog Statistics";
$l['num_members'] = "Members:";
$l['latest_member'] = "Latest member:";
$l['num_threads'] = "Blog posts:";
$l['num_posts'] = "Total comments:";
$l['full_stats'] = "Full Statistics";
$l['welcome'] = "Welcome, <em>{1}</em>";
$l['guest'] = "Guest";
...
$l['new_announcements'] = "{1} new posts";
$l['new_announcement'] = "1 new post";
$l['new_threads'] = "{1} new posts";
$l['new_thread'] = "1 new post";
$l['new_posts'] = "{1} new comments";
$l['new_post'] = "1 new comment";
...
$l['latest_posts'] = "Latest Posts";
$l['todays_birthdays'] = "Today's Birthdays";
$l['birthdayhidden'] = "Hidden";
$l['nobirthday'] = "None";
$l['usercp'] = "UserCP";
$l['since_last_activity'] = "Since Your Last Activity:";
$l['top_posters'] = "Top Posters";
$l['latest_users'] = "Latest Users";
$l['have_posts'] = "Comments";
$l['have_post'] = "Comment";
$l['no_announcement'] = "No Posts";
$l['no_announcement_desc'] = "There are no blog posts to show.";
$l['no_thread'] = "No posts have been created yet.";
